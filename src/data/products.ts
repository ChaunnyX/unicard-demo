...
export const PRODUCTS: Product[] = [
  ...
  // ---------------- VPN ----------------
  {
    ...
    bullets: ['Работает при «белых списках» мобильных операторов', 'Свои серверы с портом до 1 Гбит/с', '4 способа подключения — резерв на случай блокировок', '3 устройства одновременно'],
