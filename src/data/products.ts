...
export const CATEGORIES: CategoryMeta[] = [
  ...
  { id: 'vpn', name: 'Unicard VPN', short: 'VPN', from: 199, blurb: 'Свои серверы, 185 Мбит/с, работает при белых списках', auto: 'подписка мгновенно' },
...
export const PRODUCTS: Product[] = [
  ...
  // ---------------- VPN ----------------
  {
    ...
    bullets: ['Работает при «белых списках» мобильных операторов', 'Свои серверы: 185 Мбит/с по замеру', '4 протокола — если один заблокируют, остальные работают', '3 устройства одновременно'],
