              ...
              <div className="mt-6 flex flex-wrap items-center gap-6">
                <div>
                  <div className="flex items-baseline gap-1.5">
                    ...
                    <span className="font-display text-[34px] font-bold num">до <CountUp value={1} duration={800} /> Гбит/с</span>
                  </div>
                  <div className="text-[12px] text-white/45">порт каждого сервера</div>
                </div>
                <div>
                  <div className="font-display text-[34px] font-bold num">×7</div>
                  <div className="text-[12px] text-white/45">запас скорости для 4K-видео</div>
                </div>
                <div>
...
const FAQ = [
  ...
  { q: 'VPN правда работает при «белых списках»?', a: 'Да. Инфраструктура своя: вход через российский сервер, который проходит фильтры операторов, выход — в Европе. Портов серверов — до 1 Гбит/с, на мобильной сети выжимает максимум самого LTE. Если адрес попадёт под фильтр, система заменит его автоматически, вы этого не заметите.' },
